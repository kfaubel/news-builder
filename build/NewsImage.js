...
class NewsImage {
    ...
    async getImage(dataItem) {
        ...
        try {
            ...
            if (picture !== null) {
                ...
                ctx.drawImage(picture, 0, 0, picture.width, picture.height, // source dimensions
        ...
        // Draw the title
        const titleLines = this.splitLine(title, 48, 2);
        let lineNumber = 0;
    ...
    splitLine(inStr, maxLineLength, maxLines) {
        const list = [];
